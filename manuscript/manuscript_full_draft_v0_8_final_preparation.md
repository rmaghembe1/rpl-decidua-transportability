...
> Manuscript status: v0.8 final-preparation draft. Structured `[REF:source_key]` placeholders remain for controlled conversion to journal-formatted citations after target-journal selection.
