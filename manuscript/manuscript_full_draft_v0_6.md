...
> Citation status: v0.6 contains structured reference placeholders and expanded section-level citation maps in the form `[REF:source_key]`, mapped to `manuscript/references/formal_citation_metadata_v0_1.tsv`. These placeholders should be converted to journal-formatted citations after target-journal selection.
