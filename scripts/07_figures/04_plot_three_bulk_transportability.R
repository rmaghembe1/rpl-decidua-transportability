...
message("[figures] Plotting three-cohort GSE214607 bulk transportability results")
...
scores_files <- c(
  ...
  GSE178535 = "results/projection_scores/GSE178535_GSE214607_projection_scores_annotated.tsv"
)

summary_file <- "results/transportability/GSE214607_signature_projection_three_bulk_transportability.tsv"
concordance_file <- "results/transportability/GSE214607_signature_projection_three_bulk_concordance_summary.tsv"
...
p1 <- ggplot(target_scores, aes(x = plot_group, y = score)) +
  ...
  labs(
    title = "Three-cohort transportability of the RM decidual macrophage/APC programme",
    subtitle = "GSE214607-derived single-cell programme projected into independent bulk decidua cohorts",
    x = NULL,
    y = "Programme score"
  ) +
...
delta_plot[, dataset_label := factor(
  dataset_id,
  levels = c("GSE113790", "GSE161969", "GSE178535")
)]
...
p2 <- ggplot(
  ...
  labs(
    title = "Three-cohort directional recurrence of GSE214607-derived programmes",
...
message("  results/figures/GSE214607_macrophage_APC_three_cohort_boxplot.png")
message("  results/figures/GSE214607_macrophage_APC_three_cohort_boxplot.svg")
message("  results/figures/GSE214607_all_signature_three_cohort_delta_summary.png")
message("  results/figures/GSE214607_all_signature_three_cohort_delta_summary.svg")
message("  results/figures/GSE214607_three_cohort_figure_caption_support.tsv")
