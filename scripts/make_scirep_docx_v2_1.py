...
INPUT = Path("manuscript/RPL_decidua_scientific_reports_manuscript_v2_1.md")
OUTPUT = Path("manuscript/docx/RPL_decidua_scientific_reports_manuscript_v2_1.docx")
